<template>
  <div class="ag-login-bg">
    ...
    <div class="ag-login-card">
      ...
      <div style="margin-top:1.25rem; text-align:center;">
        <span style="font-size:0.875rem; color:var(--ag-text-3);">
          Já possui conta?
          <NuxtLink to="/login" style="color:var(--ag-primary); font-weight:600; text-decoration:none;">
            Faça login
          </NuxtLink>
        </span>
      </div>
    ...
    <p style="color:var(--ag-text-3); font-size:0.75rem; margin-top:1rem; text-align:center;">Agrovet v2.0 • Sistema em Nuvem</p>
  </div>
</template>
